export default function ProjectCard({ project }) {
  return (
    <article className="bg-[#1a1a1a] rounded-3xl overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_30px_60px_rgba(0,0,0,0.6)] shadow-[0_10px_40px_rgba(0,0,0,0.3)] cursor-pointer">
      {/* Project Image */}
      ...
      <div className="p-8">
        ...
        <p className="text-[#a1a1a6] mb-6 leading-relaxed">
          {project.description}
        </p>
